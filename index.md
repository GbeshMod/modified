...
<h1 align="center"><b>Welcome to Modified Userbot🤖 </b></h1>




## It [GbeshMod](https://telegram.dog/GbeshMod).
Have a look at my [Repo](https://github.com/GbeshMod/modified) to deploy Modified USERBOT. 
To use user bot we should have an idea about vars and Configs.
## envoirnment VARS.

**API_KEY**: you can get this value from the link given below [here](https://my.telegram.org).

**API_HASH**: automatically you are going to get this value API_KEY .

**STRING_SESSION**: After getting the  values you have to go for the [session generator](ttps://repl.it/@gbeshmod/modified#main.py) sign in with phone number in international format as +187β€¥******** or Telegram bot api 
...
**HEROKU_APP_NAME**: This Value will be same as you have filled earlier in app named heroku https://HEROKU_APP_NAME.herokuapp.com/

**GITHUB_ACCESS_TOKEN**: you can get this Value from the link given below [here](https://github.com/settings/tokens)

**GIT_REPO_NAME**: This value is required to do commits through Userbot eg.   GbeshMod/modified

**COUNTRY**: This value is required for Date , Time and Weather example:Nigeria

**TZ_NUMBER**: If the country name is not set or else showing an error then set this value example:+1.5 .
...
**BOTLOG**: Incase  if you want to turn off from the logging, you can input false.
...
**LYDIA_API_KEY**: This Module Needs CoffeeHouse API to work. so Join [here](https://telegram.dog/IntellivoidDevhere) and send #activateapi and follow instructions or [here 🚪](https://coffeehouse.intellivoid.info/)
...
if you already have an account or created one for deploying.
...
For Example :-
```
.bash ./transfer <config> <file location>
Like 
.bash ./transfer bit ./downloads/sticker.webp
```

""" modified module for managing events.
...
from modified import LOGSPAMMER, PRIVATE_GROUP_ID, bot, client2, client3
                ...
                if not disable_errors:
                    ...
                    if LOGSPAMMER:
                        await check.client.respond(
                            "`Sorry, my Modified has crashed.\
                        \nThe error logs are stored in the Modified's log chat.`"
                        )

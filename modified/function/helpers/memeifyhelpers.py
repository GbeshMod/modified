...
from wand.image import Image as modimage
...
async def mod_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def mod_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = modimage(filename=picture_name)
    main_image.resize(

...
@modex.on(modified_cmd(outgoing=True, pattern="magisk$"))
@modex.on(sudo_cmd(pattern="magisk$", allow_sudo=True))
...
@modex.on(modified_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@modex.on(sudo_cmd(pattern="device(?: |$)(\S*)", allow_sudo=True))
...
@modex.on(modified_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
@modex.on(sudo_cmd(pattern="codename(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@modex.on(modified_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@modex.on(sudo_cmd(pattern="specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@modex.on(modified_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@modex.on(sudo_cmd(pattern="twrp(?: |$)(\S*)", allow_sudo=True))

uimport asyncio
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else Var.botnickname




@bot.on(admin_cmd(pattern="kiler( (.*)|$)"))
...
@bot.on(admin_cmd(pattern=f"snake$"))
...
@bot.on(admin_cmd(pattern=f"human$"))
...
@bot.on(admin_cmd(pattern=f"mcc$"))
@bot.on(sudo_cmd(pattern="mcc$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
    animation_ttl = range(28)
    event = await edit_or_reply(event, "mcc..")
    animation_chars = [
        "◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️",
        "◻️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️",
        "◼️◻️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️\n◼️◼️◼️◼️◼️",
...
@bot.on(admin_cmd(pattern=r"repe$"))
...
@bot.on(admin_cmd(pattern=f"nikal$"))
...
@bot.on(admin_cmd(pattern=f"music$"))
...
@bot.on(admin_cmd(pattern=f"hnd"))
...
@bot.on(admin_cmd(pattern=f"squ$"))

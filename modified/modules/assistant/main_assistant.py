...
import re
import telethon
from modified import bot
from telethon.tl.functions.users import GetFullUserRequest
from modified.Configs import Config
from telethon.utils import pack_bot_file_id
from modified.modules.sql_helper.blacklist_assistant import add_nibba_in_db, is_he_added, removenibba
from telethon import Button, custom, events, functions
from modified.modules.sql_helper.botusers_sql import add_me_in_db, his_userid
from modified.modules.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
...
async def start(event):
    ...
    starttext = f"Hello, {firstname} ! Nice To Meet You, Well I Am {bot_id}, An Powerfull Modified and  Assistant Bot. \n\nMy Master [{hmmwow}](tg://user?id={bot.uid}) \nYou Can Talk/Contact My Master Using This Bot. \n\nIf You Want Your Own Assistant You Can Deploy From Button Below. \n\nPowered By [Modified Userbot](https://github.com/GbeshMod/modified)"
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_file(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your Modified", data="deploy")],
                [Button.url("Help Me ❓", "https://github.com/GbeshMod/modified")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy Modified In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
#                [Button.url("Deploy Tutorial 📺", "https://youtu.be/xfHcm_e92eQ")],
                [Button.url("Need Help ❓", "t.me/GbeshMod")],
            ],
        )

...
import modified.modules.sql_helper.blacklist_sql as sql



@modex.on(events.NewMessage(incoming=True))
...
@modex.on(modified_cmd("textblacklist ((.|\n)*)"))
@modex.on(sudo_cmd("textblacklist ((.|\n)*)", allow_sudo=True))
...
@modex.on(modified_cmd("listblacklist"))
@modex.on(sudo_cmd("listblacklist", allow_sudo=True))
...
@modex.on(modified_cmd("rmblacklist ((.|\n)*)"))
@modex.on(sudo_cmd("rmblacklist ((.|\n)*)", allow_sudo=True))

...
@modex.on(modified_cmd(pattern="clone ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
\n**Usage :** Get Telegram Profile Picture and other information and set as own profile...sıɥʇ ǝpoɔǝp uǝɥʇ llıʇu∩ ˙ ǝɔɐds ǝʇɐʌıɹd ǝɯos ǝɯ ǝʌı⅁˙"
    }
)

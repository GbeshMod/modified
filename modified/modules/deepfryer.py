...
from .function import convert_to_image, crop_vid, runcmd
...
@modbot.on(modified_cmd(pattern="deepfry (?: |$)(.*)"))
@modbot.on(sudo_cmd(pattern="deepfry (?: |$)(.*)", allow_sudo=True))
async def deepfryer(event):
    ...
    image.save("./deepfly/fried.png")
    file_name = "fried.png"
    ok = "./deepfly/" + file_name

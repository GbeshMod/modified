...
@borg.on(admin_cmd(pattern="googles(.*)"))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@borg.on(admin_cmd(pattern="google i(.*)"))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@borg.on(admin_cmd(pattern="google rs"))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@borg.on(admin_cmd(pattern="googl"))
...
CMD_HELP.update(
    {
        "google": "**Google**\
\n\n**Syntax : **`.googles <text to search>`\
\n**Usage :** Get the Google search result for given text.\n**Syntax : **`.google i <image to search>`\
\n**Usage :** Get the Google search result for given image.\n**Syntax : **`.google rs <text to search>`\
\n**Usage :** Get Google search image to do Google Reverse Search\
\n\n**Syntax : **`.googl <text to search>`\
\n**Usage :** Get the Google search result for given text."
    }
)

...
from . import media_type, progressf
...
@bot.on(admin_cmd(outgoing=True, pattern="base64 (en|de) ?(.*)"))
@bot.on(sudo_cmd(allow_sudo=True, pattern="base64 (en|de) ?(.*)"))
@errors_handler
...
"hash": "**Hash**\
\n\n**Syntax : **`.hash <text>`\
\n**Usage :** It encrypts given text into MD5, SHA1, SHA256, SHA512. OR Find the md5, sha1, sha256, sha512 of the string when written into a txt file.\
\n\n**Syntax : **`.base64 en to encode-text or .base64 de encoded-text`\

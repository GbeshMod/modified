...
@modbit.on(modified_cmd(outgoing=True, pattern="lyrics (.*)"))
@modbit.on(sudo_cmd(pattern="lyrics (.*)", allow_sudo=True))
async def _(event):
...
@modbit.on(modified_cmd(outgoing=True, pattern="glyrics (?: |$)(.*)"))

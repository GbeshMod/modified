...
from . import ALIVE_NAME, modmemes
...
async def _(e):
    txt = random.choice(modmemes.CONGOREACTS)
...
async def shrugger(e):
    txt = random.choice(modmemes.SHGS)
    await edit_or_reply(e, txt)
...
async def runner_lol(e):
    txt = random.choice(modmemes.RUNSREACTS)
    await edit_or_reply(e, txt)
...
async def metoo(e):
    txt = random.choice(modmemes.NOOBSTR)
    await edit_or_reply(e, txt)
...
async def insult(e):
    txt = random.choice(modmemes.INSULT_STRINGS)
    await edit_or_reply(e, txt)
...
async def hoi(e):
    txt = random.choice(modmemes.HELLOSTR)
    await edit_or_reply(e, txt)
...
async def proo(e):
    txt = random.choice(modmemes.PRO_STRINGS)
    await edit_or_reply(e, txt)
...
async def _(e):
    ...
    if input_str in "happy":
        emoticons = modmemes.FACEREACTS[0]
    elif input_str in "think":
        emoticons = modmemes.FACEREACTS[1]
    elif input_str in "wave":
        emoticons = modmemes.FACEREACTS[2]
    elif input_str in "wtf":
        emoticons = modmemes.FACEREACTS[3]
    elif input_str in "love":
        emoticons = modmemes.FACEREACTS[4]
    elif input_str in "confused":
        emoticons = modmemes.FACEREACTS[5]
    elif input_str in "dead":
        emoticons = modmemes.FACEREACTS[6]
    elif input_str in "sad":
        emoticons = modmemes.FACEREACTS[7]
    elif input_str in "dog":
        emoticons = modmemes.FACEREACTS[8]
    else:
        emoticons = modmemes.FACEREACTS[9]

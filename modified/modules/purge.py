...
from modified import BOTLOG, BOTLOG_CHATID, CMD_HELP
from modified.utils import errors_handler, register
...
@bot.on(admin_cmd(pattern="sdm (\d*) (.*)"))
...
@bot.on(admin_cmd(pattern="selfdm (\d*) (.*)"))
...
CMD_HELP.update(
    {
        ...
        .del Usage: Deletes the message you replied to.\
        .edit <newmessage> Usage: Replace your last message with <newmessage>.\
        .sd <x> <message>\

...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.edit(
            "Removed image's Background in {} seconds, powered by @Modifiedbot ".format(ms)
        )
    else:
        await event.edit(
            "ReMove.BG API returned Errors. Please report to @Modifiedbot \n`{}".format(

...
from modified.modules.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@modbot.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@modbot.on(modified_cmd("snipd (\S+)"))

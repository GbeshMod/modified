...
sedpath = Config.TRASH_DOWNLOAD_DIRECTORY


@modbot.on(modified_cmd(pattern="vt(?: |$) (.*)"))
@modbot.on(sudo_cmd(pattern="vt(?: |$) (.*)", allow_sudo=True))
async def download(target_file):
    ...
    if Config.VIRUSTOTAL_API_KEY is None:
        ...
        return
    await gbesh.edit("Processing using fridaybot server ( ◜‿◝ )♡")
    ...
    if target_file.reply_to_msg_id:
        ...
        await gbesh.edit("Reply to a file..")
    ...
    try:
        ...
        await gbesh.edit("your file is larger than 32 mb.")
    try:
        await gbesh.edit(
            f"<b><u> File Scan Request Complete</u></b>\n\n<b>Link of the report➫</b>\n{b}\n\nNote➫ Please open the link after 5-10 minutes.\n\n<b>Virus Scan Completed By {BOT_N_N}</b>",
            parse_mode="HTML",
        )
    except:
        await gbesh.edit("your file is larger than 32 mb.   --__--")

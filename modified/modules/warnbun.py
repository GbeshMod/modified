...
CMD_HELP.update(
    {
        "warnbun": "**Warns Burning **\
\n\n**Syntax : **`.warn0 <reason> <reply or mention the user>`\
\n**Usage :** Warns The Given User.\
\n\n**Syntax : **`.warn1 <reply or mention the user>`\
\n**Usage :**  Warn Of The User.\
\n\n**Syntax : **`.warn2 <reply or mention the user>`\
\n**Usage :**  Warns Of The Given User.\
\n\n**Syntax : **`.warn3 <reply or mention the user>`\
\n**Usage :**  Warns Of The Given User.\
\n\n**Syntax : **`.ocd or    .fw \
\n**Usage :**  Warns Of The Given User."
    }

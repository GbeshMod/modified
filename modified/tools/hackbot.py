...
def handle(msg):
	...
	#welcome screen and help
		if command.startswith('hhelp') or command.startswith('/hackbot'):
...
#api credentials
TOKEN_TELE = Config.TG_BOT_TOKEN_BF_HER
bot = telepot.Bot(TOKEN_TELE)
...
__help__ = """࿇  ➬ 1. Run built-in tools : example -> nmap -sV site.com\n ࿇  ➬ 2. Give Foldername and Command : example -> tool foldername python scriptname.py\n ࿇  ➬ 3. BTC Rate : example -> btc usd or btc anycurrency\n ࿇  ➬ 4. Hackerone Disclosed Bugs : usage : h1bugs\n ࿇  ➬ 5. Get Tweets of any search and times : usage : tweet bugbounty 5 or tweet motivation 3\n ࿇  ➬ 6. Get details of HackerOne disclosed report: usage: #152407 \n A # sign followed by the report number\n ࿇  ➬ 7. Hackerone Disclosed Bugs for specific program: usage: h1bugs programname\n ࿇  ➬ 8. Get automatically notified about latest HackerOne Disclosure: usage: notifyh1\n ࿇  ➬ 9. Search Wikipedia. usage: wiki yourtiopic\n ࿇  ➬ 10. Get YouTube videos delivered right to your box in mp3 format: usage: yt musicname\n ࿇  ➬ 11. Get motivated every hour. Just text -> motivateme\n"""

__mod_name__ = "HACK BOT"